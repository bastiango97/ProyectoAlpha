...
*/
    ...
    public class MessListener2 implements MessageListener {
        ...
        public void onMessage(Message message) {
            ...
            try {
                System.out.println(textMessage.getText());
                System.out.println();
                puntuacion.setText(textMessage.getText());
                Thread.sleep(3000);
                frame.dispose();
            } catch (JMSException e) {
                e.printStackTrace();
    ...
    public Socket crear(int serverPort){
        try {
    ...
    public void crearHunter(int aID) throws InterruptedException {
        Hunter h = new Hunter();
        h.setID(aID);
        Socket s = null;
        Thread.sleep(5000);
